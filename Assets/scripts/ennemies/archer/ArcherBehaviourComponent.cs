...
public class ArcherBehaviourComponent : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Target != null)
        {
            ...
            if (fireElapsedTime >= fireDelay && Range>= Vector3.Distance(gameObject.transform.position, Target.transform.position))
            {
                ...
                //}
                    ...
                    {*/
                        animator.Play("shootBow");
                        Target.GetComponent<HealthComponent>().TakeDamage((int)Damage);
                        ShootArrowWithDelay();
                        fireElapsedTime = 0;
                    /*}*/
            }
